...
|기능           |기본 단축키        |변경 가능|설정 항목     |설명                                 |
|:---           |:---              |:---:   |:---         |:---                                 |
|키보드 패드    |화살표 키          |O       |pad_type     |키보드로 캐릭터 이동. (변경은 ARROW 또는 WASD만 가능.)  |
...
> |:---:|:---:|:---:|:---:|:---|
> |Q|←|50px|0.1초|이동 키를 클릭한 상태에서 드래그.|
> |W|↑|50px|0.1초|이동 키를 클릭한 상태에서 드래그.|
> |E|↓|50px|0.1초|이동 키를 클릭한 상태에서 드래그.|
> |R|→|50px|0.1초|이동 키를 클릭한 상태에서 드래그.|
> |A|←|50px|0.1초|이동 키와 공격 키를 모두 클릭한 상태에서 드래그.|
> |S|↑|50px|0.1초|이동 키와 공격 키를 모두 클릭한 상태에서 드래그.|
> |D|↓|50px|0.1초|이동 키와 공격 키를 모두 클릭한 상태에서 드래그.|
> |F|→|50px|0.1초|이동 키와 공격 키를 모두 클릭한 상태에서 드래그.|
>
> ### 제스처 액션 
...
|기능           |기본 단축키       |변경 가능|설정 항목  |설명                                   |
|:---           |:---             |:---:   |:---      |:---                                   |
|키보드 패드    |WASD 키           |O       |pad_type  |키보드로 캐릭터 이동. (변경은 ARROW 또는 WASD만 가능.)  |
